...
def test_load_mtgdecks_meta_decks_file_skips_records_without_cards(tmp_path: Path) -> None:
    meta_file = tmp_path / "meta.json"
    meta_file.write_text(
        json.dumps(
            [
                {
                    "format": "standard",
                    "name": "Winrates",
                    "url": "https://mtgdecks.net/Standard/winrates",
                    "metagame_share": None,
                    "top_deck": None,
                },
                {
                    ...
                    "top_deck": {
                        "url": "https://mtgdecks.net/Standard/izzet-prowess-decklist-by-gnawe-2931400",
                        "cards": [{"count": 4, "name": "Monastery Swiftspear"}],
                    },
                },
            ]
        ),
    ...
    assert len(documents) == 1
    assert documents[0].title == "Izzet Prowess (Standard)"
